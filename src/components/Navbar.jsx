...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-50 w-full px-6 py-4 md:px-12 flex justify-between items-center transition-all duration-300 ${scrolled
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="fixed top-16 left-6 w-2/5 max-w-[200px] z-40 bg-background-light/95 dark:bg-background-dark/95 border border-gray-200 dark:border-gray-800 rounded-xl shadow-lg py-4 transition-all duration-300">

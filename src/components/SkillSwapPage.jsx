                ...
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <ul className="text-gray-600 dark:text-gray-300 space-y-2 mb-6">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Skill marketplace platform</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="material-symbols-outlined text-primary mt-1 flex-shrink-0">check_circle</span>
                      <span>Course discovery and purchase system</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="material-symbols-outlined text-primary mt-1 flex-shrink-0">check_circle</span>
                      <span>Instructor monetization tools</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="material-symbols-outlined text-primary mt-1 flex-shrink-0">check_circle</span>
                      <span>User-friendly learning interface</span>
                    </li>
                  </ul>

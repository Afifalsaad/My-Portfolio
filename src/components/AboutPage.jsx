            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-1">
                <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl p-6 flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Afif Al Saad</h3>
                ...
                <div className="space-y-8">
                  <section>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      ...
                      With a strong foundation in both frontend and backend technologies, I build solutions 
                      that are not only visually appealing but also highly functional and scalable.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      <div className="border-l-4 border-primary pl-4 py-1">
                        <h3 className="font-bold text-gray-900 dark:text-white">Full Stack Developer</h3>
                      ...
                      <div className="border-l-4 border-primary pl-4 py-1">
                        <h3 className="font-bold text-gray-900 dark:text-white">Frontend Developer</h3>
                  ...
                  <section>
                    ...
                    <div className="space-y-4">
                      <div className="border-l-4 border-primary pl-4 py-1">
                        <h3 className="font-bold text-gray-900 dark:text-white">Bachelor of Science in Computer Science</h3>
